...
Font.register({
  ...
  fonts: [
    {
      src: "https://cdn.jsdelivr.net/npm/@expo-google-fonts/noto-sans-kr@0.2.3/NotoSansKR_400Regular.ttf",
      fontWeight: "normal",
    },
    {
      src: "https://cdn.jsdelivr.net/npm/@expo-google-fonts/noto-sans-kr@0.2.3/NotoSansKR_700Bold.ttf",
      fontWeight: "bold",
    },
    {
      src: "https://cdn.jsdelivr.net/npm/@expo-google-fonts/noto-sans-kr@0.2.3/NotoSansKR_900Black.ttf",
      fontWeight: "heavy",
    },
  ],
});
...
const ProposalPDF = ({ data }: { data: PdfData }) => (
  <Document>
    <Page size="A4" style={pdfStyles.page}>
      ...
      <View style={pdfStyles.headerContainer}>
        <View>
          ...
          <View style={pdfStyles.siteTag}>
            ...
            <Text
              style={{
                ...pdfStyles.siteTagValue,
                color: data.siteName ? "#0f172a" : "#94a3b8",
              }}
            >
      ...
      <Text style={pdfStyles.descText}>
        귀사의 현장 운영 데이터를 기반으로 산출된 초고효율 LED 및 IoT 스마트
        제어 시스템 도입에 따른 예상 에너지 절감액 및 투자 회수(ROI) 분석
        결과입니다.
      </Text>
        ...
        <View style={{ marginBottom: 12 }}>
          ...
          <View style={pdfStyles.tableContainer}>
            ...
            {data.lights.length > 0 ? (
              <>
                {data.lights.slice(0, 5).map((l: LightItem, i: number) => (
                  <View
                    key={i}
                    style={{
                      ...pdfStyles.tableRow,
                      borderBottom:
                        i === 4 || i === data.lights.length - 1
                          ? "none"
                          : "1px solid #e2e8f0",
                    }}
                  >
          ...
          <View style={pdfStyles.splitRow}>
            <View style={pdfStyles.col}>
              ...
              <View style={pdfStyles.cardLight}>
                <Text style={pdfStyles.cardLabelLight}>
                  개선 전 (기존 요금)
                </Text>
                <View style={pdfStyles.valContainer}>
                  <Text style={pdfStyles.subLight}>
                    월 평균 {formatNum(data.monthlyOldCost)} 원
                  </Text>
                  <Text>
                    <Text style={pdfStyles.valLight}>
                      {formatNum(data.oldCost)}
                    </Text>
              ...
              <View style={pdfStyles.cardSlate}>
                ...
                <View style={pdfStyles.valContainer}>
                  <Text style={pdfStyles.subSlate}>
                    월 평균 {formatNum(data.monthlySmartCost)} 원
                  </Text>
                  <Text>
                    <Text style={pdfStyles.valSlate}>
                      {formatNum(data.smartCost)}
                    </Text>
              ...
              <View style={pdfStyles.cardYellow}>
                ...
                <View style={pdfStyles.valContainer}>
                  <Text style={pdfStyles.subYellow}>
                    월 평균 {formatNum(data.monthlySave)} 원
                  </Text>
                  <Text>
                    <Text style={pdfStyles.valYellow}>
                      {formatNum(data.totalSave)}
                    </Text>
            ...
            <View style={pdfStyles.col}>
              ...
              <View style={pdfStyles.cardLight}>
                ...
                <View style={pdfStyles.valContainer}>
                  <Text style={{ ...pdfStyles.subLight, color: "transparent" }}>
                    spacer
                  </Text>
                  <Text>
                    <Text style={pdfStyles.valLight}>
                      {formatNum(data.totalCost)}
                    </Text>
                    <Text style={pdfStyles.unitLight}> 원</Text>
                  </Text>
                </View>
              ...
              <View style={pdfStyles.cardSlate}>
                <Text style={pdfStyles.cardLabelSlate}>
                  예상 투자수익률 (ROI)
                </Text>
                <View style={pdfStyles.valContainer}>
                  <Text style={{ ...pdfStyles.subSlate, color: "transparent" }}>
                    spacer
                  </Text>
                  <Text>
                    <Text style={pdfStyles.valSlate}>
              ...
              <View style={pdfStyles.cardYellow}>
                <Text style={pdfStyles.cardLabelYellow}>
                  투자금 전액 회수 기간
                </Text>
                <View style={pdfStyles.valContainer}>
                  <Text
                    style={{ ...pdfStyles.subYellow, color: "transparent" }}
                  >
                    spacer
                  </Text>
                  <Text>
                    <Text style={pdfStyles.valYellow}>
                      {data.totalSave > 0 && data.totalCost > 0
                        ? data.paybackYears.toFixed(1)
                        : "0"}
                    </Text>
...
function CountUp({
  ...
  return (
    <span>
      {isCurrency
        ? new Intl.NumberFormat("ko-KR").format(Math.round(displayValue))
...
export default function App() {
  ...
  const [formNewW, setFormNewW] = useState<number | string>(
  ...
  const roi =
    totalCost > 0 && totalSave > 0 ? (totalSave / totalCost) * 100 : 0;
  const paybackYears =
    totalSave > 0 && totalCost > 0 ? totalCost / totalSave : 0;
  ...
  return (
    <div
      className={`min-h-screen font-['Pretendard',sans-serif] pb-24 selection:bg-yellow-500 selection:text-slate-900 bg-[#020617]`}
    >
      <style>
        {`
      ...
      {!isPreviewMode && (
        <div className={isPdfGenerating ? "hidden" : "block"}>
          <div className="border-b border-slate-800 bg-[#050b14] py-10 text-center relative overflow-hidden">
            <h1 className="text-2xl md:text-3xl font-black text-white mb-2 tracking-tight relative z-10">
              스마트 에너지 솔루션 시뮬레이터
            </h1>
            <p className="text-slate-400 text-sm md:text-base font-medium relative z-10">
              데이터를 입력하시면 하단 리포트에 실시간 동기화됩니다.
            </p>
          </div>
      ...
      >
        ...
        >
          ...
          <div className="flex-1 flex flex-col w-full h-full relative z-10">
            <div
              className={`px-5 sm:px-8 lg:px-12 ${isPreviewMode ? "pt-6 md:pt-10" : "pt-8 md:pt-14"}`}
            >
              <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center pb-4 border-b border-slate-800 mb-6">
                <div className="mb-3 lg:mb-0">
                  <p className="text-slate-500 font-bold tracking-widest text-[10px] sm:text-xs lg:text-sm mb-1 lg:mb-2 whitespace-nowrap">
                    FLOLIM ENERGY SOLUTION
                  </p>
                  <h1 className="text-2xl sm:text-[28px] md:text-[32px] lg:text-4xl font-black tracking-tight break-keep text-white whitespace-nowrap sm:whitespace-normal">
                    스마트 조명 도입 성과 분석 리포트
                  </h1>
                  <div className="mt-2 lg:mt-3 inline-block px-3 py-1.5 rounded-lg border bg-slate-900 border-slate-800 whitespace-nowrap">
                    <span className="inline-block align-middle mr-2 text-slate-500 text-xs font-bold">
                      대상 현장
                    </span>
                    <span
                      className={`inline-block align-middle ${siteName ? "text-yellow-500" : "text-slate-600"} text-sm lg:text-base font-black`}
                    >
                      {siteName || "현장명 미입력"}
                    </span>
                  </div>
                </div>
                <div className="text-left lg:text-right text-[11px] sm:text-xs lg:text-sm text-slate-500 font-medium whitespace-nowrap">
                  분석 기준일 : {new Date().toLocaleDateString("ko-KR")}
                </div>
              </div>
              {!isPreviewMode && (
                <p className="text-slate-400 text-xs sm:text-sm lg:text-base font-medium break-keep mb-8">
                  귀사의 현장 운영 데이터를 기반으로 산출된 초고효율 LED 및 IoT
                  스마트 제어 시스템 도입에 따른{" "}
                  <strong className="text-white">
                    예상 에너지 절감액 및 투자 회수(ROI) 분석 결과
                  </strong>
                  입니다.
                </p>
              )}
            ...
            <div
              className={`px-5 sm:px-8 lg:px-12 flex-1 flex flex-col justify-center ${isPreviewMode ? "pt-2 lg:pt-4" : ""}`}
            >
              <div className="mb-6 lg:mb-8 shrink-0">
                <h3 className="text-base lg:text-xl font-black border-l-[4px] lg:border-l-[5px] border-slate-600 text-white pl-3 lg:pl-4 mb-3 lg:mb-5 break-keep whitespace-nowrap">
                  교체 대상 조명 내역
                </h3>
              ...
              <div className="flex flex-col w-full mb-8 lg:mb-12 shrink-0 mt-4">
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 w-full">
                  <div className="flex-1 flex flex-col w-full">
                    ...
                    <div className="flex flex-col gap-3 lg:gap-4">
                      <div className="w-full min-h-[110px] lg:min-h-[130px] bg-slate-900 border border-slate-800 p-4 lg:p-5 rounded-xl flex flex-col">
                        <span className="text-slate-500 font-bold text-xs lg:text-sm break-keep whitespace-nowrap self-start">
                          개선 전 (기존 요금)
                        </span>
                        <div className="mt-auto flex flex-col items-end pt-3 w-full">
                          <div className="text-[10px] lg:text-xs text-slate-600 font-medium mb-1 leading-none">
                            월 평균 {formatNum(monthlyOldCost)} 원
                          </div>
                          <div className="flex items-baseline gap-1.5">
                            <span className="text-xl lg:text-2xl font-black text-slate-400 tracking-tighter">
                              <CountUp
                                value={oldCost}
                                animate={isPreviewMode}
                                isCurrency={true}
                              />
                            </span>
                      ...
                      <div className="w-full min-h-[110px] lg:min-h-[130px] bg-slate-800 border border-slate-700 p-4 lg:p-5 rounded-xl flex flex-col">
                        <span className="text-slate-300 font-bold text-xs lg:text-sm break-keep whitespace-nowrap self-start">
                          도입 후 예상 요금
                        </span>
                        <div className="mt-auto flex flex-col items-end pt-3 w-full">
                          <div className="text-[10px] lg:text-xs text-slate-400 font-medium mb-1 leading-none">
                            월 평균{" "}
                            <CountUp
                              value={monthlySmartCost}
                              animate={isPreviewMode}
                              isCurrency={true}
                            />{" "}
                            원
                      ...
                      <div className="w-full min-h-[110px] lg:min-h-[130px] bg-yellow-500/10 border-2 border-yellow-500/50 p-4 lg:p-5 rounded-xl flex flex-col">
                        <span className="text-yellow-500 font-black text-sm lg:text-base break-keep whitespace-nowrap leading-tight self-start">
                          순수 요금 절감액
                        </span>
                        <div className="mt-auto flex flex-col items-end pt-3 w-full">
                          <div className="text-[10px] lg:text-xs text-yellow-500/80 font-bold mb-1 leading-none inline-block">
                            월 평균{" "}
                            <CountUp
                              value={monthlySave}
                              animate={isPreviewMode}
                          ...
                          <div className="flex items-baseline gap-1.5">
                            <span className="text-3xl lg:text-4xl font-black text-yellow-400 tracking-tighter">
                              <CountUp
                                value={totalSave}
                                animate={isPreviewMode}
                                isCurrency={true}
                            ...
                            <span className="text-[10px] lg:text-xs font-bold text-yellow-400">
                              원
                            </span>
                          </div>
                        </div>
                  ...
                  <div className="flex-1 flex flex-col w-full">
                    <h3 className="block lg:hidden text-base font-black border-l-[4px] border-slate-600 text-white pl-3 mb-4 break-keep whitespace-nowrap">
                      투자 성과 요약
                    </h3>
                    <h3 className="hidden lg:block text-lg font-black border-l-[5px] border-slate-600 text-white pl-4 mb-4 break-keep whitespace-nowrap">
                      투자 성과 요약
                    </h3>
                    <div className="flex flex-col gap-3 lg:gap-4">
                      <div className="w-full min-h-[110px] lg:min-h-[130px] bg-slate-900 border border-slate-800 p-4 lg:p-5 rounded-xl flex flex-col">
                        ...
                        <div className="mt-auto flex flex-col items-end pt-3 w-full">
                          <div className="text-[10px] lg:text-xs text-transparent font-medium mb-1 leading-none select-none">
                            spacer
                          </div>
                          <div className="flex items-baseline gap-1.5">
                            <span className="text-xl lg:text-2xl font-black text-slate-400 tracking-tighter">
                      ...
                      <div className="w-full min-h-[110px] lg:min-h-[130px] bg-yellow-500/10 border-2 border-yellow-500/50 p-4 lg:p-5 rounded-xl flex flex-col">
                        ...
                        <div className="mt-auto flex flex-col items-end pt-3 w-full">
                          <div className="text-[10px] lg:text-xs text-transparent font-bold mb-1 leading-none select-none">
                            spacer
                          </div>
                          <div className="flex items-baseline gap-1.5">
                            <span className="text-3xl lg:text-4xl font-black text-yellow-400 tracking-tighter">
                              {totalSave > 0 && totalCost > 0 ? (
                                <CountUp
                                  value={paybackYears}
                                  animate={isPreviewMode}
                                  decimals={1}
